...
<center>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	          ...
	          <a href="#" onclick="openWin('user/add_input.jsp?personId=${person.id }','assignUser',600,100);">分配帐号:${person.id }</a>
	          <a href="#" onclick="del('del_user.action?id=${person.user.id }');">删除帐号</a>
	          <a href="#" onclick="openWin('user/update_input.jsp?userId=${person.user.id }&personId=${person.id }','chgpsw',600,100);">修改帐号</a>
	          <a href="#" onclick="openWin('userRole.action?id=${person.user.id }','assignRole',600,400);">分配角色</a>
	          <a href="#" onclick="openWin('acl.action?principalType=User&principalSn=${person.user.id }','RoleAuth',600,500,1);">给用户授权</a>
	          </td>
        </tr>
        </c:forEach>
		</c:if>
