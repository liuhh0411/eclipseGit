	...
	<TBODY>
      ...
      <TABLE width="100%" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          <TR>
            ...
            <a href="#" onclick="openWin('toUserRole.action?id=${user.id }','userRoleInput',600,200);">给用户分配角色</a>
            </TD>
          </TR>
          <TR>
      ...
      <table width="100%" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	          ...
	          <a href="#" onclick="del('del_userRole.action?id=${ur.user.id }&roleId=${ur.role.id}');">删除关联</a>
	          </td>
        </tr>
        </c:forEach>
		</c:if>
